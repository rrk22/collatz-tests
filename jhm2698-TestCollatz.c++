...
TEST(CollatzFixture, eval_5) {
    const int v = collatz_eval(9249, 9240);
    ASSERT_EQ(185, v);}

TEST(CollatzFixture, eval_6) {
    const int v = collatz_eval(15281, 15891);
    ASSERT_EQ(253, v);}

TEST(CollatzFixture, eval_7) {
    const int v = collatz_eval(3020, 3300);
    ASSERT_EQ(199, v);}
...
TEST(CollatzFixture, cycle_length_3) {
    const int v = cycle_length (200);
    ASSERT_EQ(27, v);}

TEST(CollatzFixture, cycle_length_4) {
    const int v = cycle_length (1560);
    ASSERT_EQ(123, v);}

TEST(CollatzFixture, cycle_length_5) {
    const int v = cycle_length (6555);
    ASSERT_EQ(50, v);}
