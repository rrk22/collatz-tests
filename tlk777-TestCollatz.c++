...
TEST(CollatzFixture, read_5) {
    string s("500000 900123\n");
    const pair<int, int> p = collatz_read(s);
    ASSERT_EQ( 500000, p.first);
    ASSERT_EQ(900123, p.second);}
// ----
// eval
// ----
...
TEST(CollatzFixture, eval_7) {
    const int v = collatz_eval(500000, 900123);
    ASSERT_EQ(470, v);}

/*
TEST(CollatzFixture, eval_7) {
    const int v = collatz_eval(10, 900123);
    ASSERT_EQ(20, v);}
*/// -----
// print
// -----
...
TEST(CollatzFixture, print_6) {
    ostringstream w;
    collatz_print(w, 500000, 900123, 470);
    ASSERT_EQ("500000 900123 470\n", w.str());}
